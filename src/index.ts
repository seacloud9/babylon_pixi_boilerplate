...
const customProcText = new BABYLON.CustomProceduralTexture("customtext", "basic", 512, scene);
customProcText.setVector2("resolution", new BABYLON.Vector2(1, 1));
customProcText.setTexture("texture0", new BABYLON.Texture("./textures/lensdirt.jpg", scene));
